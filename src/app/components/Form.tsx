    ...
    <>
      ...
      <div className="w-screen  my-10">
        ...
        >
          ...
          <button
            type="submit"
            className="text-white bg-gray-700  focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
            Submit
          </button>
        </form>
